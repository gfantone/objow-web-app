...
import { QuarterFilter, MonthFilter, SemesterFilter, WeekFilter, YearFilter } from './components'
import { Select } from '..'
...
const periods = [ weekPeriod, monthPeriod, quarterPeriod, semesterPeriod, yearPeriod ]
...
const PeriodFilter = ({}) => {
    ...
    return (
        <div>
            <Select name='period' label='Période' value={period} onChange={setPeriod} options={periods} optionValueName='id' optionTextName='name' />
