        ...
        <div className={classes.root}>
            <Grid container spacing={2}>
                { isCollaborator && <GridLink item component={Link} to={`/collaborators/${account.id}/detail`}>
                    <Avatar src={photo} className={classes.avatar} onClick={onNavigate} entityId={ account.id } fallbackName={ account.fullname } fontSize={ 34 } />
                </GridLink> }
                { !isCollaborator && <Grid item>
                    <Avatar src={photo} className={classes.avatar} entityId={ account.id } fallbackName={ account.fullname } fontSize={ 34 } />
                </Grid> }
