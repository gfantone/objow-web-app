...
class GoalStats extends MainLayoutComponent {
    state = {collaborator: null, definition: null, filterRequiredLoaded: false, period: null, team: null}
    ...
    componentDidMount() {
        ...
        this.collaborator = collaboratorIdParam ? Number(collaboratorIdParam) : null
            ...
            <Grid container spacing={4}>
                {this.category && this.period && (this.collaborator || this.team) && <Grid item xs={12}>
                    <StatsFilter
                        ...
                        onFilterRequiredLoaded={this.handleFilterRequiredLoaded.bind(this)}
                    />
                </Grid>}
                <Grid item xs={12}>
                    <StatsData
