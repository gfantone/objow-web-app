    ...
    return (
        <div>
            ...
            <RoundedTabs value={!activateRank && value === 0 ? 1 : value} onChange={handleChange} variant='fullWidth'>
                { activateRank && <RoundedTab value={0} label={Resources.TEAM_COLLABORATOR_GOAL_DETAIL_RANK_TAB} /> }
                <RoundedTab value={1} label={Resources.TEAM_COLLABORATOR_GOAL_DETAIL_INDICATION_TAB} />
