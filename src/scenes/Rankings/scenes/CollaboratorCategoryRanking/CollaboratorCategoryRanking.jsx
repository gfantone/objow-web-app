...
class PlayerCategoryRanking extends MainLayoutComponent {
  ...
  componentDidMount() {
    ...
    this.props.collaboratorCategoryRankListActions.getCollaboratorCategoryRankListByCategory(
      this.categoryId,
      this.periodId,
    );
    ...
    return collaborators
      ? ranks.map((rank) =>
          Object.assign({}, rank, {
            color: _.get(
              collaborators.find(
                (collaborator) => collaborator.id === rank.collaboratorId,
              ),
              'team.color.hex',
            ),
          }),
  ...
  renderData() {
    ...
    return (
      <PlayerRanking
        ranking={
          team
            ? this.addColorToRanks(ranks, collaborators).filter(
                (rank) =>
                  _.get(
                    collaborators.find(
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(injectIntl(PlayerCategoryRanking));
