...
const mapStateToProps = ({ auth, categoryList, challengeAwardTypeList, challengeUpdate, challengeDetail, challengeImageList, challengeTypeList, challengeTypeUsablePoints, kpiList, currentPeriodDetail }) => ({
    auth,
    categoryList,
