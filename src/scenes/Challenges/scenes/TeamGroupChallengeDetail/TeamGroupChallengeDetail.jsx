...
import * as teamGroupChallengeDetailActions from '../../../../services/TeamGroupChallenges/TeamGroupChallengeDetail/actions';
...
class TeamGroupChallengeDetail extends MainLayoutComponent {
  constructor(props) {
    super(props);
  ...
  handleDuplicate() {
    const { challenge } = this.props.teamGroupChallengeDetail;
  ...
  refresh(teamGroup, search) {
    ...
    var url = `/challenges/detail/team-group/${id}`;
    if (teamGroup) {
  ...
  componentDidMount() {
    ...
    this.props.teamGroupChallengeDetailActions.getTeamGroupChallengeDetail(id);
    this.props.teamChallengeGoalListActions.getTeamChallengeGoalListByTeamGroup(
      id
    );
    this.props.teamChallengeRankListAction.getTeamChallengeRankListByTeamGroup(
      id,
      teamGroup,
      name
    );
    ...
    return (
      ...
      >
        ...
        <MainContainer maxWidth='md' style={{ paddingTop: 0 }}>
          ...
          {this.state.page == 1 && _.get(challenge, 'teamGroupId') && (
            <ChallengeCollaboratorFilter
              open={this.state.filterOpen}
...
const mapDispatchToProps = (dispatch) => ({
  ...
  teamGroupChallengeDetailActions: bindActionCreators(
    teamGroupChallengeDetailActions,
    dispatch
  ),
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(withWidth()(injectIntl(TeamGroupChallengeDetail))));
