...
const SubHeader = ({ activateRank, onChange, ...props }) => {
  ...
  var { challenge, loading: teamChallengeDetailLoading } =
    props.teamGroupBasedChallengeDetail;
  const { loading: teamChallengeGoalListLoading } =
    props.teamGroupBasedChallengeGoalList;
  const { loading: teamChallengeRankListLoading } =
    props.teamGroupBasedChallengeRankList;
  const loading =
    teamChallengeDetailLoading ||
    teamChallengeGoalListLoading ||
    teamChallengeRankListLoading;
