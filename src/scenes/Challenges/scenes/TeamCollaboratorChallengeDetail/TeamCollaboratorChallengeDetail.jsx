...
class TeamCollaboratorChallengeDetail extends MainLayoutComponent {
  ...
  componentDidMount() {
    ...
    this.props.collaboratorChallengeRankListActions.getCollaboratorChallengeRankListByTeamCollaboratorChallenge(
      id,
      null,
      team,
      teamGroup,
    ...
    this.props.teamCollaboratorChallengeDetailActions.getTeamCollaboratorChallengeDetail(
      id
    );
    this.props.teamCollaboratorChallengeGoalListActions.getTeamCollaboratorChallengeGoalList(
      id
    );
      ...
      >
        ...
        <MainContainer maxWidth='md' style={{ paddingTop: 0 }}>
          ...
          {account.hasChallengeRankAccess && this.state.page == 0 && ranks && (
            <React.Fragment>
              <CollaboratorChallengeRankList
                teamId={_.get(challenge, 'source_team_id')}
                ranks={ranks}
          ...
          {this.state.page == 1 && _.get(challenge, 'source_team_id') && (
            <div style={{ marginBottom: 10 }}>
              <CollaboratorFilterAndSearchBar
                open={this.state.filterOpen}
                team={_.get(challenge, 'source_team_id')}
                onClose={() => {}}
...
const mapDispatchToProps = (dispatch) => ({
  ...
  teamCollaboratorChallengeDetailActions: bindActionCreators(
    teamCollaboratorChallengeDetailActions,
    dispatch
  ),
  teamCollaboratorChallengeGoalListActions: bindActionCreators(
    teamCollaboratorChallengeGoalListActions,
    dispatch
  ),
...
export default connect(
  ...
  withStyles(styles)(
    withWidth()(injectIntl(withRouter(TeamCollaboratorChallengeDetail)))
  )
);
