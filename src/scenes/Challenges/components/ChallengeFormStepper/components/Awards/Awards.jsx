            ...
            <Grid container spacing={1} alignItems='center'>
              ...
              <Grid item xs>
                <Grid container direction='column' spacing={1}>
                  <Grid item>
                    <DefaultTitle>
                      {intl.formatMessage({ id: 'challenge.form.mode' })} :{' '}
                      {intl.formatMessage({
                        id: `challenge.modes.${currentType.code}`,
                      })}
                      {currentType.code === 'P' && (
                        <span
                          style={{
                  ...
                  const validationErrors =
                    isMaxAward || currentType.code === 'P'
                      ? {
                          ...
                          isRankingDecreasing: intl.formatMessage({
                            id: 'common.form.increasing_rewards',
                          }),
                        }
                      : {
                          isInt: intl.formatMessage({
                          ...
                          isRankingIncreasing: intl.formatMessage({
                            id: 'common.form.decreasing_rewards',
                          }),
                        };
                                        ...
                                        <Grid item xs={8}>
                                          <TextField
                                            ...
                                            validationErrors={{
                                              ...
                                              isStepsIncreasing:
                                                intl.formatMessage({
                                                  id: 'common.form.increasing_scores',
                                                }),
                                            }}
                                          />
                                        </Grid>
                                    ...
                                    <Grid item xs={8}>
                                      <TextField
                                        ...
                                        validationErrors={{
                                          ...
                                          isStepsIncreasing: intl.formatMessage(
                                            {
                                              id: 'common.form.increasing_scores',
                                            }
                                          ),
