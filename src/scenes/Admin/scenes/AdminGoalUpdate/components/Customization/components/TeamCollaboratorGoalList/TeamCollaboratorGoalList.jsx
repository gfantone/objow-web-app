...
class TeamCollaboratorGoalList extends Component {
    ...
    render() {
        const { goals, loading: teamPlayerGoalListLoading } = this.props.teamPlayerGoalList
...
const mapStateToProps = ({ goalDefinitionDetail, goalDetail, teamPlayerGoalList, teamPlayerGoalListUpdate, accountDetail }) => ({
...
const mapDispatchToProps = (dispatch) => ({
    ...
    teamPlayerGoalListUpdateActions: bindActionCreators(teamPlayerGoalListUpdateActions, dispatch)
})

export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(TeamCollaboratorGoalList))
