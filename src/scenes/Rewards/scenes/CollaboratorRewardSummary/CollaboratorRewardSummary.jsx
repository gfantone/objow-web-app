                    ...
                    <Grid item xs={12} md={7}>
                        <Grid container spacing={1}>
                            <Grid item xs={12}>
                                ...
                                <DefaultTitle>{Resources.COLLABORATOR_REWARD_SUMMARY_REWARDS_AREA.format(order.id, name)}</DefaultTitle>
                            </Grid>
                            <Grid item xs={12}>
...
export default connect(mapStateToProps, mapDispatchToProps)(CollaboratorRewardSummary)
