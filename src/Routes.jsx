    ...
    return (
        <BrowserRouter>
            <Switch>
                ...
                <AdminRoutes exact path='/rewards/collaborator-orders/:id/summary' component={scenes.CollaboratorRewardSummary} />
                ...
                <AdminRoutes exact path='/rewards/team-orders/:id/summary' component={scenes.TeamRewardSummary} />
