...
function* createGoalAdviceListByCollaboratorGoal(action) {
    try {
        yield call(api.collaboratorGoals.changeAdvices, action.goalId, action.advices);
        const [
            { data: goal },
            { data: levels },
            { data: definition },
...
function* createGoalAdviceListByTeamCollaboratorGoal(action) {
    try {
        yield call(api.teamCollaboratorGoals.changeAdvices, action.goalId, action.advices);
        const [
            { data: goal },
            { data: levels },
            { data: definition },
