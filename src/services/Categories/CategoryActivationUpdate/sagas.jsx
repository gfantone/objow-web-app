...
import {updateCategoryActivationSuccess, updateCategoryActivationError} from './actions'
...
function* watchCategoryActivationUpdate() {
    yield takeEvery(types.UPDATE_CATEGORY_ACTIVATION, updateCategoryActivation)
}
