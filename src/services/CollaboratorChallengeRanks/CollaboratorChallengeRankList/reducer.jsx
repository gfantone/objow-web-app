...
const CollaboratorChallengeRankList = (
  state = initialState.collaboratorChallengeRankList,
  action,
) => {
  switch (action.type) {
    ...
    case types.GET_COLLABORATOR_CHALLENGE_RANK_LIST_BY_TEAM_GROUP_COLLABORATOR_CHALLENGE:
    ...
    case types.GET_COLLABORATOR_CHALLENGE_RANK_LIST_CLEAR:
      return { ...state, ranks: null, loading: false, hasError: false };
