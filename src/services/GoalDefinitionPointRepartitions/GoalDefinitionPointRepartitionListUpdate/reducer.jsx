...
const GoalDefinitionPointRepartitionListUpdate = (state = initialState.goalDefinitionPointRepartitionListUpdate, action) => {

    switch (action.type) {
        case actionTypes.UPDATE_GOAL_DEFINITION_POINT_REPARTITION_LIST:
            return {...state, pointRepartitions: action.pointRepartitions, loading: true, hasError: false}
