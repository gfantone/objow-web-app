...
// Admin - Aircall form
export const ADMIN_AIRCALL_FORM_AC_GET_CALLS_ACTIVATION =
  'Activer le KPI de récupération des appels aboutis';
export const ADMIN_AIRCALL_FORM_AC_GET_CALLS_DURATION =
  'Durée minimale d’un appel abouti (secondes)';
...
export const ADMIN_GOAL_CREATION_LIVE_INFOS =
  'Si activé, les points seront automatiquement gagnés par les participants avant la date de fin de l’objectif.';
export const ADMIN_GOAL_CREATION_EDITABLE_LABEL =
  'Objectif modifiable par les managers';
export const ADMIN_GOAL_CREATION_PAST_EDITABLE_LABEL =
  'Objectif passé modifiable par les administrateurs';
export const ADMIN_GOAL_CREATION_ALLOW_OVER_TARGET_LABEL =
  "Dépassement de l'objectif alloué";
export const ADMIN_GOAL_CREATION_ALLOW_RANKING_LABEL =
  'Affichage du classement';
export const ADMIN_GOAL_CREATION_ADMIN_EDITABLE_LABEL =
  'Objectif modifiable par les administrateurs';
...
// Admin - Goal update
export const ADMIN_GOAL_UPDATE_BASE_TITLE =
  "Modification de l'objectif « {0} »";
export const ADMIN_GOAL_UPDATE_READONLY_TITLE =
  "Visualisation de l'objectif « {0} »";
...
export const ADMIN_GOAL_UPDATE_LIVE_INFOS =
  'Si activé, les points seront automatiquement gagnés par les participants avant la date de fin de l’objectif.';
export const ADMIN_GOAL_UPDATE_EDITABLE_LABEL =
  'Objectif modifiable par les managers';
export const ADMIN_GOAL_UPDATE_ADMIN_EDITABLE_LABEL =
  'Objectif modifiable par les administrateurs';
export const ADMIN_GOAL_UPDATE_SUBMIT_BUTTON = 'Valider';
export const ADMIN_GOAL_UPDATE_DISABLE_BUTTON = 'Archiver';
export const ADMIN_GOAL_UPDATE_DISABLE_MESSAGE =
  "Êtes-vous sûr de vouloir archiver l'objectif « {0} » ?";
export const ADMIN_GOAL_UPDATE_DISABLE_INFO =
  'Après l’archivage de cet objectif, il ne sera plus possible de le réactiver. Tous les points attribués sur les objectifs en cours et ultérieurs seront remis à disposition.';
export const ADMIN_GOAL_UPDATE_YES_BUTTON = 'Oui';
export const ADMIN_GOAL_UPDATE_NO_BUTTON = 'Non';
export const ADMIN_GOAL_UPDATE_CONFIRMATION_MESSAGE =
  "Êtes-vous sûr de vouloir Modifier le KPI de cet objectif ? Cette modification peut avoir des conséquences sur l'historique des résultats. En cas de doute, n'hésitez pas à contacter nos services.";
...
export const ADMIN_PARTNER_DETAIL_EMPTY_CONNECTION =
  'Pour utiliser ces fonctionnalités, veuillez installer Fire Tiger sur votre espace client Aircall.';
...
export const ADMIN_REWARD_CATEGORY_LIST_SUBTITLE =
  'Configuration des catégories de récompenses';
...
export const ADMIN_REWARD_CATEGORY_CREATION_SUBTITLE =
  "Création d'une catégorie de récompenses";
...
export const ADMIN_REWARD_CATEGORY_UPDATE_SUBTITLE =
  "Modification d'une catégorie de récompenses";
...
export const ADMIN_USER_UPDATE_PASSWORD_CONFIRM =
...
export const ADMINISTRATOR_COLLABORATOR_SELECTOR_EMPTY_STATE_TITLE =
  'Aucune équipe trouvée';
export const ADMINISTRATOR_COLLABORATOR_SELECTOR_EMPTY_STATE_MESSAGE =
...
export const AIRCALL_INSTALL_AUTHORIZATION_ERROR =
...
export const CHALLENGE_AWARD_LIST_POINTS_CALCULATION_MESSAGE =
  'Calcul des pts utilisables...';
export const CHALLENGE_AWARD_LIST_USABLE_POINTS = '{0} pts utilisables';
export const CHALLENGE_AWARD_LIST_TYPE_LABEL = 'Mode';
export const CHALLENGE_AWARD_LIST_COLLABORATOR_MAX_POINT_LABEL =
  'Maximum / joueur';
...
export const CHALLENGE_AWARD_LIST_LIVE_INFOS =
  'Si activé, les points seront automatiquement gagnés par les participants avant la date de fin du challenge.';
...
export const COLLABORATOR_CHALLENGE_LIST_EMPTY_STATE_TITLE =
  'Aucun challenge trouvé';
export const COLLABORATOR_CHALLENGE_LIST_EMPTY_STATE_MESSAGE =
  "Si vous avez appliqué des filtres, changez-les pour afficher d'autres challenges";

// Challenge - Condition
export const CHALLENGE_CONDITION_CONDITION_AREA = 'Indicateurs';
export const CHALLENGE_CONDITION_GOAL_INFO =
  'La condition fixée ici peut être atteinte plusieurs fois. Chaque fois que celle-ci est atteinte elle rapporte le nombre de points associés';
export const CHALLENGE_RACE_CONDITION_GOAL_INFO =
  "Si l'objectif est atteint, il rapporte 1 point de score";
...
export const CHALLENGE_CONDITION_COLLABORATOR_MAX_POINTS_LABEL =
  'Maximum / joueur';
...
export const CHALLENGE_CREATION_GOAL_TARGET_INFO_TEXT =
  'La condition fixée ici peut être atteinte plusieurs fois. Chaque fois que celle-ci est atteinte elle rapporte le nombre de points associés.';
export const CHALLENGE_CREATION_GOAL_POINTS_LABEL = 'Pts';
export const CHALLENGE_CREATION_SUBMIT_BUTTON = 'Valider';
export const CHALLENGE_CREATION_AWARD_TYPE_DESCRIPTION_M =
  'Chaque {1} gagne le nombre de points correspondants à son score, dans la limite du maximum défini';
export const CHALLENGE_CREATION_AWARD_TYPE_DESCRIPTION_R =
  'Récompense pour les X {0} à la fin du challenge';
export const CHALLENGE_CREATION_AWARD_TYPE_DESCRIPTION_P =
  'La récompense obtenue par les participants dépend du niveau de performance atteint';
export const CHALLENGE_CREATION_AWARD_TYPE_DESCRIPTION_C =
  'Récompense pour les X {0} à atteindre les objectifs du challenge';
export const CHALLENGE_CREATION_AWARD_TYPE_MINIMUM_PARTICIPANTS =
  'Ce mode nécessite au moins {0} {1}';
...
export const CHALLENGE_STEP_MODE_INFORMATION =
  'Maximum 1 récompense par participant (la récompense gagnée est celle du plus haut palier)';
...
export const CHALLENGE_DUPLICATION_INFO_NO_IMAGE_TEXT =
  'Aucune image sélectionée';
...
export const CHALLENGE_DUPLICATION_INFO_IMAGE_LABEL =
...
export const CHALLENGE_DUPLICATION_GOAL_TARGET_INFO_TEXT =
  'La condition fixée ici peut être atteinte plusieurs fois. Chaque fois que celle-ci est atteinte elle rapporte le nombre de points associés.';
...
export const TEAM_CHALLENGE_LIST_EMPTY_STATE_MESSAGE =
  "Si vous avez appliqué des filtres, changez-les pour afficher d'autres challenges";
...
export const CHALLENGE_UPDATE_GOAL_TARGET_INFO_TEXT =
  'La condition fixée ici peut être atteinte plusieurs fois. Chaque fois que celle-ci est atteinte elle rapporte le nombre de points associés.';
...
export const COACHING_LIST_EMPTY_STATE_COLLABORATOR_MESSAGE =
  'Revenez plus tard lorsque votre manager vous coachera';
export const COACHING_LIST_EMPTY_STATE_MANAGER_MESSAGE =
  'Créer une première instruction pour votre collaborateur';
...
export const COLLABORATOR_REWARD_ORDER_SUMMARY_TITLE =
  "Récapitulatif d'une commande";
export const COLLABORATOR_REWARD_ORDER_SUMMARY_REWARDS_AREA =
  'Commande n°{0} de {1}';
...
export const COLLABORATOR_REWARD_ORDER_TRACKING_WAITING_POINTS_COLUMN =
  'Pts à valider';
export const COLLABORATOR_REWARD_ORDER_TRACKING_VALIDATED_POINTS_COLUMN =
  'Pts validés';
export const COLLABORATOR_REWARD_ORDER_TRACKING_VALUE_COLUMN = 'Montant total';
export const COLLABORATOR_REWARD_ORDER_TRACKING_ORDER_DATE_COLUMN =
  'Date de commande';
export const COLLABORATOR_REWARD_ORDER_TRACKING_VALIDATION_DATE_COLUMN =
  'Date de validation';

// Collaborator reward order validation
export const COLLABORATOR_REWARD_ORDER_VALIDATION_TITLE =
  "Validation d'une commande";
export const COLLABORATOR_REWARD_ORDER_VALIDATION_REWARDS_AREA =
  'Commande n°{0} de {1}';
export const COLLABORATOR_REWARD_ORDER_VALIDATION_POINTS_AREA =
  'Total commande';
export const COLLABORATOR_REWARD_ORDER_VALIDATION_POINTS_AREA_YEAR =
  'Année {0}';
...
export const COMMON_IS_MORE_THAN_OR_EQUALS_0_ERROR =
  'La valeur doit être supérieure ou égal à 0.';
export const COMMON_MAX_LENGTH_128_ERROR =
  'La valeur doit faire moins de 128 caractères.';
export const COMMON_PASSWORD_NOT_MATCH_ERROR =
...
export const CONTACT_EVOLUTION_FORM_TITLE =
  "Remplissez ce formulaire pour votre demande d'évolution";
export const CONTACT_EVOLUTION_FORM_MESSAGE_LABEL = 'Message';
export const CONTACT_EVOLUTION_FORM_SUBMIT_BUTTON = 'Envoyer';
export const CONTACT_INCIDENT_FORM_TITLE =
  "Remplissez ce formulaire pour votre déclaration d'indicent";
...
export const COLLABORATOR_GOAL_CATEGORY_LIST_TITLE =
...
export const COLLABORATOR_GOAL_LIST_EMPTY_STATE_MESSAGE =
  "Si vous avez appliqué des filtres, changez-les pour afficher d'autres objectifs";
...
export const COLLABORATOR_GOAL_LIST_EDITION_MAX_TARGET_LABEL =
  'Objectif alloué pour la période sélectionnée';
export const COLLABORATOR_GOAL_LIST_EDITION_ALL_TARGET_LABEL =
  'Objectif utilisé';
export const COLLABORATOR_GOAL_LIST_EDITION_REMAINING_TARGET_LABEL =
  'Objectif restant';
export const COLLABORATOR_GOAL_LIST_EDITION_EMPTY_STATE_TITLE =
  'Aucun objectif trouvé';
export const COLLABORATOR_GOAL_LIST_EDITION_EMPTY_STATE_MESSAGE =
  "Si vous avez appliqué des filtres, changez-les pour afficher d'autres objectifs";
export const COLLABORATOR_GOAL_LIST_EDITION_ERROR_TEXT =
  "Veuillez respecter l'objectif total alloué pour la période sélectionnée";
...
export const GOAL_INDICATION_LIVE_INFO =
  'Si activé, les points seront automatiquement gagnés par les participants avant la date de fin de l’objectif.';
...
export const TEAM_GOAL_LIST_EMPTY_STATE_MESSAGE =
  "Si vous avez appliqué des filtres, changez-les pour afficher d'autres objectifs";
...
export const GOAL_DUPLICATION_DIALOG_MESSAGE =
  'Appliquer automatiquement à {0} les objectifs du collaborateur suivant :';
...
export const GOAL_DUPLICATION_DIALOG_CONFIRMATION_MESSAGE =
  'Êtes-vous sûr de vouloir appliquer automatiquement à {0} les objectifs de {1} ?';
...
export const LOGIN_SSO_ERROR_MESSAGE =
  "Le SSO n'est pas configuré. Veuillez contacter un administrateur de Firetiger";
export const LOGIN_STORE_MESSAGE_1 =
...
export const POINT_SUMMARY_WAITING_POINTS_LABEL =
...
export const COLLABORATOR_CATEGORY_RANKING_EMPTY_STATE_TITLE =
  'Aucun classement disponible';

// Ranking - Collaborator challenge ranking
export const COLLABORATOR_CHALLENGE_RANKING_TITLE =
  'Classement des challenges individuels';
export const COLLABORATOR_CHALLENGE_RANKING_EMPTY_STATE_TITLE =
  'Aucun classement disponible';

// Ranking - Collaborator general ranking
export const COLLABORATOR_GENERAL_RANKING_TITLE =
  'Classement général individuel';
export const COLLABORATOR_GENERAL_RANKING_EMPTY_STATE_TITLE =
  'Aucun classement disponible';
...
export const COLLABORATOR_RANK_LIST_EMPTY_STATE_TITLE =
...
export const COLLABORATOR_RANKING_LIST_FILTER_COLLABORATOR_LABEL =
  'Collaborateur';
...
export const TEAM_CATEGORY_RANKING_EMPTY_STATE_TITLE =
  'Aucun classement disponible';

// Ranking - Team challenge ranking
export const TEAM_CHALLENGE_RANKING_TITLE =
  "Classement des challenges d'équipe";
export const TEAM_CHALLENGE_RANKING_EMPTY_STATE_TITLE =
  'Aucun classement disponible';

// Ranking - Team general ranking
export const TEAM_GENERAL_RANKING_TITLE = "Classement général d'équipe";
export const TEAM_GENERAL_RANKING_EMPTY_STATE_TITLE =
  'Aucun classement disponible';
...
export const REWARD_IMAGE_INPUT_INFOS =
  'L’affichage de l’image s’adapte et varie en fonction de la taille de l’écran utilisé par l’utilisateur. Le format d’image recommandé pour un affichage optimal est le suivant : 1024x700.';
...
export const REWARD_DETAIL_DELIVERY_TIME_TEXT =
  'Temps de livraison estimé : {0}';
...
export const REWARD_DETAIL_OPERATION_STEP_1_DESCRIPTION =
  'Vous devez vérifier votre commande et valider votre panier. Une notification sera ensuite adressée à l’administrateur de votre société pour l’informer de votre demande.';
...
export const REWARD_DETAIL_OPERATION_STEP_2_DESCRIPTION =
  'Votre commande est en attente de traitement/validation. Les points utilisés au moment de votre commande sont retirés de votre de solde de points.';
export const REWARD_DETAIL_OPERATION_STEP_3_NUMBER = '3';
export const REWARD_DETAIL_OPERATION_STEP_3_TITLE = 'Commande en cours';
export const REWARD_DETAIL_OPERATION_STEP_3_DESCRIPTION =
  'L’administrateur de votre société prend en charge votre commande. Une fois validée et facturée par le fournisseur, vos points sont définitivement décomptés de votre solde de points.';
...
export const REWARD_DETAIL_OPERATION_STEP_4_DESCRIPTION =
  'Votre récompense est en route ! Vous êtes informé par l’administrateur de votre société. Votre récompense sera déclarée et soumise à cotisations patronales et/ou salariales.';
...
export const REWARD_MANAGEMENT_COLLABORATOR_SELECTOR_AREA =
...
export const REWARD_ORDER_SUMMARY_RECIPIENT_POINTS_LABEL =
...
export const REWARD_ORDER_SUMMARY_REMAINING_POINTS_LABEL =
  'Prochain solde de points';
...
export const REWARD_ORDER_SUMMARY_CONFIRM_ORDER_TITLE =
  'Êtes-vous sûr de vouloir valider votre commande de {0} Pts pour une valeur de {1} € ?';
export const REWARD_ORDER_SUMMARY_CONFIRM_ORDER_MESSAGE =
  'Une fois validée, vous ne pourrez plus annuler votre commande, les points seront retirés de votre solde de point et la valeur de votre commande sera déclarée et soumise à cotisation patronales et/ou salariales.';
...
export const REWARD_ORDER_SUMMARY_CONFIRM_VALIDATE_TITLE =
  "Êtes-vous sûr de vouloir valider la commande N°{0} d'un total de {1} Pts pour une valeur de {2} € ?";
export const REWARD_ORDER_SUMMARY_CONFIRM_VALIDATE_MESSAGE =
  'Une fois validée, vous ne pourrez plus annuler la commande, les points seront retirés du solde de points disponible et la valeur de cette commande devra être déclarée et soumise à cotisations patronales et/ou salariales.';
...
export const REWARD_ORDER_SUMMARY_CONFIRM_REFUSE_TITLE =
  "Êtes-vous sûr de vouloir refuser la commande N°{0} d'un total de {1} Pts pour une valeur de {2} € ?";
export const REWARD_ORDER_SUMMARY_CONFIRM_REFUSE_MESSAGE =
  "Une fois refusée, il ne sera plus possible de la réactiver, les points seront réattribués au solde de point disponible. Il sera de votre responsabilité d'informer l'utilisateur de la raison du refus.";
...
// Reward - settings
export const REWARD_SETTINGS_COLLABORATOR_REWARD_ACTIVATION_OPTION =
  'Activer les récompenses « joueur »';
export const REWARD_SETTINGS_TEAM_REWARD_ACTIVATION_OPTION =
  'Activer les récompenses « équipe »';
...
export const REWARD_SHOPPING_CART_ADDING_CONFIRMATION_MESSAGE =
  'Vous venez d’ajouter ce produit à votre panier :';
export const REWARD_SHOPPING_CART_ADDING_CONFIRMATION_SHOPPING_CART_BUTTON =
  'Aller au panier';
export const REWARD_SHOPPING_CART_ADDING_CONFIRMATION_CLOSE_BUTTON =
  'Continuer vos achats';

// Reward - Store
export const REWARD_STORE_EMPTY_STATE_TITLE = 'Aucune récompense trouvée';
export const REWARD_STORE_EMPTY_STATE_MESSAGE =
  'Si vous avez appliqué des filtres, changez-les pour afficher d’autres récompenses';
...
export const STATS_GOALS_EMPTY_STATE_MESSAGE =
  'Modifiez les filtres pour afficher d’autres statistiques';
...
export const TEAM_LIST_EMPTY_STATE_MESSAGE =
  "Les équipes n'ont pas encore été créées";
...
// Team reward store
export const STORE_TEAM_COLLABORATOR_DEPARTMENT_COLLABORATOR_SELECTOR_AREA =
  "Sélection d'un joueur";
...
export const TEAM_REWARD_ORDER_TRACKING_VALIDATION_DATE_COLUMN =
  'Date de validation';

// Team reward order validation
export const TEAM_REWARD_ORDER_VALIDATION_TITLE = "Validation d'une commande";
export const TEAM_REWARD_ORDER_VALIDATION_REWARDS_AREA =
  'Commande n°{0} de {1}';
...
export const TEAM_SELECTOR_EMPTY_STATE_MESSAGE =
  "Les équipes n'ont pas encore été créées";
...
export const ERROR_PAGE_MESSAGE =
  "Vous pouvez mettre à jour l'application pour résoudre le problème";
